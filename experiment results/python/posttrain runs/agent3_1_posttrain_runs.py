...
linear_model=tf.keras.models.load_model('C:\\Users\\owenb\\Desktop\\experiment results\\trained regression models\\agent3-1.h5')
...
print("agent 3-1 posttrain standard deviation="+str(statistics.pstdev(avg_error))+" and mean="+str(statistics.mean(avg_error)))
