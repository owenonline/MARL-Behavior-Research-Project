...
linear_model=tf.keras.models.load_model('C:\\Users\\owenb\\Desktop\\experiment results\\trained regression models\\agent2.h5')
...
print("agent 2 posttrain standard deviation="+str(stdev(avg_error))+" and mean="+str(mean(avg_error)))
